...
"""
Python 2.5 bytecode disassembler

This sets up opcodes Python's 2.5 and calls a generalized
...
class Disassemble26(Disassemble2):
    ...
    def __init__(self):
        super(Disassemble2, self).__init__(2.5)
...
if __name__ == "__main__":
    ...
    if PYTHON_VERSION == 2.5:
        ...
        print("Need to be Python 2.5 to demo; I am %s." %
              PYTHON_VERSION)
