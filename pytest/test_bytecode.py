...
def test_offset2line():
    ...
    for offset, expect in (
        ...
        assert expect == got, "offset=%d, got=%d, expect=%d" % (offset, got, expect)
    ary = ((20, 1), (50, 10))
    for offset, expect in ((10, 0), (55, 10), (20, 1), (50, 10)):
        got = offset2line(offset, ary)
        assert expect == got, "offset=%d, got=%d, expect=%d" % (offset, got, expect)
    ary = ((25, 1),)
    for offset, expect in ((10, 0), (30, 1), (25, 1)):
        got = offset2line(offset, ary)
        assert expect == got, "offset=%d, got=%d, expect=%d" % (offset, got, expect)
    ary = tuple()
...
def test_find_linestarts():
    ...
    if sys.version_info[0:2] == (2, 7):
        ...
        expect = [(0, 17), (6, 18), (9, 19), (19, 20), (32, 21), (42, 22), (67, 23)]
...
def findlabels():
    ...
    # Python 2.7 code
    if hasattr(bug708901, "__code__"):
        code = bug708901.__code__
    else:
        code = bug708901.func_code
