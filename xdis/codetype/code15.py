...
from xdis.codetype.code14 import Code14
...
class Code15(Code14):
    ...
    It also functions as an object that can be used
    to build or write a Python 1.5 code object, since we allow mutable structures.
