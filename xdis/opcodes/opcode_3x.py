...
_def_op('LOAD_BUILD_CLASS',     71,  0,  1)
...
name_op('IMPORT_FROM',         109,  0,  1)  # Operand is in name list
...
local_op('DELETE_FAST',        126,  0,  0)   # Local variable number
