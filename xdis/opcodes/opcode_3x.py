...
_def_op('BUILD_SET', 104)        # Number of set items
_def_op('BUILD_MAP', 105)        # Number of dict entries (upto 255)
name_op('LOAD_ATTR', 106)       # Index in name list
_def_op('COMPARE_OP', 107)       # Comparison operator
