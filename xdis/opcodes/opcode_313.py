...
# ---------------------------------------------------------------
def_op(loc, "BEFORE_ASYNC_WITH"                , 1)
def_op(loc, "BEFORE_WITH"                      , 2)
def_op(loc, "BINARY_SLICE"                     , 4)
def_op(loc, "BINARY_SUBSCR"                    , 5)
def_op(loc, "CHECK_EG_MATCH"                   , 6)
def_op(loc, "CHECK_EXC_MATCH"                  , 7)
def_op(loc, "CLEANUP_THROW"                    , 8)
def_op(loc, "DELETE_SUBSCR"                    , 9)
def_op(loc, "END_ASYNC_FOR"                    , 10)
def_op(loc, "END_FOR"                          , 11)
def_op(loc, "END_SEND"                         , 12)
def_op(loc, "EXIT_INIT_CHECK"                  , 13)
def_op(loc, "FORMAT_WITH_SPEC"                 , 15)
def_op(loc, "GET_AITER"                        , 16)
def_op(loc, "GET_ANEXT"                        , 18)
def_op(loc, "GET_ITER"                         , 19)
def_op(loc, "GET_LEN"                          , 20)
def_op(loc, "GET_YIELD_FROM_ITER"              , 21)
def_op(loc, "INTERPRETER_EXIT"                 , 22)
def_op(loc, "LOAD_ASSERTION_ERROR"             , 23)
def_op(loc, "LOAD_BUILD_CLASS"                 , 24)
def_op(loc, "LOAD_LOCALS"                      , 25)
def_op(loc, "MAKE_FUNCTION"                    , 26)
def_op(loc, "MATCH_KEYS"                       , 27)
def_op(loc, "MATCH_MAPPING"                    , 28)
def_op(loc, "MATCH_SEQUENCE"                   , 29)
def_op(loc, "NOP"                              , 30)
def_op(loc, "POP_EXCEPT"                       , 31)
def_op(loc, "POP_TOP"                          , 32)
def_op(loc, "PUSH_EXC_INFO"                    , 33)
def_op(loc, "PUSH_NULL"                        , 34)
def_op(loc, "RETURN_GENERATOR"                 , 35)
def_op(loc, "RETURN_VALUE"                     , 36)
def_op(loc, "SETUP_ANNOTATIONS"                , 37)
def_op(loc, "STORE_SLICE"                      , 38)
def_op(loc, "STORE_SUBSCR"                     , 39)
def_op(loc, "UNARY_INVERT"                     , 41)
def_op(loc, "UNARY_NEGATIVE"                   , 42)
def_op(loc, "UNARY_NOT"                        , 43)
def_op(loc, "WITH_EXCEPT_START"                , 44)
def_op(loc, "BINARY_OP"                        , 45)
def_op(loc, "BUILD_CONST_KEY_MAP"              , 46)
def_op(loc, "BUILD_LIST"                       , 47)
def_op(loc, "BUILD_MAP"                        , 48)
def_op(loc, "BUILD_SET"                        , 49)
def_op(loc, "BUILD_SLICE"                      , 50)
def_op(loc, "BUILD_STRING"                     , 51)
def_op(loc, "BUILD_TUPLE"                      , 52)
def_op(loc, "CALL"                             , 53)
def_op(loc, "CALL_FUNCTION_EX"                 , 54)
def_op(loc, "CALL_INTRINSIC_1"                 , 55)
def_op(loc, "CALL_INTRINSIC_2"                 , 56)
def_op(loc, "COMPARE_OP"                       , 58)
def_op(loc, "CONTAINS_OP"                      , 59)
def_op(loc, "COPY"                             , 61)
def_op(loc, "COPY_FREE_VARS"                   , 62)
def_op(loc, "DELETE_ATTR"                      , 63)
def_op(loc, "DELETE_DEREF"                     , 64)
def_op(loc, "DELETE_FAST"                      , 65)
def_op(loc, "DELETE_GLOBAL"                    , 66)
def_op(loc, "DELETE_NAME"                      , 67)
def_op(loc, "DICT_MERGE"                       , 68)
def_op(loc, "DICT_UPDATE"                      , 69)
def_op(loc, "ENTER_EXECUTOR"                   , 70)
def_op(loc, "EXTENDED_ARG"                     , 71)
def_op(loc, "FOR_ITER"                         , 72)
def_op(loc, "GET_AWAITABLE"                    , 73)
def_op(loc, "IMPORT_FROM"                      , 74)
def_op(loc, "IMPORT_NAME"                      , 75)
def_op(loc, "IS_OP"                            , 76)
def_op(loc, "JUMP_BACKWARD"                    , 77)
def_op(loc, "JUMP_BACKWARD_NO_INTERRUPT"       , 78)
def_op(loc, "JUMP_FORWARD"                     , 79)
def_op(loc, "LIST_APPEND"                      , 80)
def_op(loc, "LIST_EXTEND"                      , 81)
def_op(loc, "LOAD_ATTR"                        , 82)
def_op(loc, "LOAD_CONST"                       , 83)
def_op(loc, "LOAD_DEREF"                       , 84)
def_op(loc, "LOAD_FAST"                        , 85)
def_op(loc, "LOAD_FAST_AND_CLEAR"              , 86)
def_op(loc, "LOAD_FAST_CHECK"                  , 87)
def_op(loc, "LOAD_FAST_LOAD_FAST"              , 88)
def_op(loc, "LOAD_FROM_DICT_OR_DEREF"          , 89)
def_op(loc, "LOAD_FROM_DICT_OR_GLOBALS"        , 90)
def_op(loc, "LOAD_GLOBAL"                      , 91)
def_op(loc, "LOAD_NAME"                        , 92)
def_op(loc, "LOAD_SUPER_ATTR"                  , 93)
def_op(loc, "MAKE_CELL"                        , 94)
def_op(loc, "MAP_ADD"                          , 95)
def_op(loc, "MATCH_CLASS"                      , 96)
def_op(loc, "POP_JUMP_IF_FALSE"                , 97)
def_op(loc, "POP_JUMP_IF_NONE"                 , 98)
def_op(loc, "POP_JUMP_IF_NOT_NONE"             , 99)
def_op(loc, "POP_JUMP_IF_TRUE"                 , 100)
def_op(loc, "RAISE_VARARGS"                    , 101)
def_op(loc, "RERAISE"                          , 102)
def_op(loc, "RETURN_CONST"                     , 103)
def_op(loc, "SEND"                             , 104)
def_op(loc, "SET_ADD"                          , 105)
def_op(loc, "SET_UPDATE"                       , 107)
def_op(loc, "STORE_ATTR"                       , 108)
def_op(loc, "STORE_DEREF"                      , 109)
def_op(loc, "STORE_FAST"                       , 110)
def_op(loc, "STORE_FAST_LOAD_FAST"             , 111)
def_op(loc, "STORE_FAST_STORE_FAST"            , 112)
def_op(loc, "STORE_GLOBAL"                     , 113)
def_op(loc, "STORE_NAME"                       , 114)
def_op(loc, "SWAP"                             , 115)
def_op(loc, "UNPACK_EX"                        , 116)
def_op(loc, "UNPACK_SEQUENCE"                  , 117)
def_op(loc, "YIELD_VALUE"                      , 118)
def_op(loc, "RESUME"                           , 149)
def_op(loc, "INSTRUMENTED_RESUME"              , 236)
def_op(loc, "INSTRUMENTED_END_FOR"             , 237)
def_op(loc, "INSTRUMENTED_END_SEND"            , 238)
def_op(loc, "INSTRUMENTED_RETURN_VALUE"        , 239)
def_op(loc, "INSTRUMENTED_RETURN_CONST"        , 240)
def_op(loc, "INSTRUMENTED_YIELD_VALUE"         , 241)
def_op(loc, "INSTRUMENTED_LOAD_SUPER_ATTR"     , 242)
def_op(loc, "INSTRUMENTED_FOR_ITER"            , 243)
def_op(loc, "INSTRUMENTED_CALL"                , 244)
def_op(loc, "INSTRUMENTED_CALL_KW"             , 245)
def_op(loc, "INSTRUMENTED_CALL_FUNCTION_EX"    , 246)
def_op(loc, "INSTRUMENTED_INSTRUCTION"         , 247)
def_op(loc, "INSTRUMENTED_JUMP_FORWARD"        , 248)
def_op(loc, "INSTRUMENTED_JUMP_BACKWARD"       , 249)
def_op(loc, "INSTRUMENTED_POP_JUMP_IF_FALSE"   , 251)
def_op(loc, "INSTRUMENTED_POP_JUMP_IF_NONE"    , 252)
def_op(loc, "INSTRUMENTED_POP_JUMP_IF_NOT_NONE", 253)
def_op(loc, "JUMP"                             , 256)
def_op(loc, "JUMP_NO_INTERRUPT"                , 257)
def_op(loc, "LOAD_CLOSURE"                     , 258)  # psuedo-instruction
def_op(loc, "LOAD_METHOD"                      , 259)
def_op(loc, "LOAD_SUPER_METHOD"                , 260)
def_op(loc, "LOAD_ZERO_SUPER_ATTR"             , 261)
def_op(loc, "LOAD_ZERO_SUPER_METHOD"           , 262)
def_op(loc, "POP_BLOCK"                        , 263)
def_op(loc, "SETUP_CLEANUP"                    , 264)
def_op(loc, "SETUP_FINALLY"                    , 265)
def_op(loc, "SETUP_WITH"                       , 266)
def_op(loc, "STORE_FAST_MAYBE_NULL"            , 267)
