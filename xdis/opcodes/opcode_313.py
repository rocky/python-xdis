...
def_op(loc, "RETURN_GENERATOR"                 , 35  , 0 , 0)
...
def_op(loc, "INSTRUMENTED_END_FOR"             , 237 , 2 , 0)
...
def_op(loc, "POP_BLOCK"                        , 263 , 0 , 1)
def_op(loc, "SETUP_CLEANUP"                    , 264 , 0 , 1)
