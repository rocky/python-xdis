...
#   Pushes: result
binary_op_graal(loc, "BINARY_SUBSCR", 0x8, 1, 2, 0)
...
# Pushes: call result
#
call_op_graal(loc, "CALL_COMPREHENSION", 0x44, 0, 2, 1)
#
...
# Pushes: call result
#
call_op_graal(loc, "CALL_FUNCTION_KW", 0x45, 0, 3, 1)
#
