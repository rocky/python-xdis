...
import xdis.opcodes.opcode_graal
import xdis.opcodes.opcode_graal.base_graal
...
findlabels = xdis.opcodes.opcode_graal.base_graal.findlabels
...
#
const_op_graal(loc, "LOAD_CONST_COLLECTION", 0x40, 2, 0, 2)
...
# Pushes: call result
#
call_op_graal(loc, "CALL_METHOD_VARARGS", 65, 1, 1)
#
...
# Pushes: call result
#
call_op_graal(loc, "CALL_COMPREHENSION", 0x44, 0, 2)
#
...
# Pushes: call result
#
call_op_graal(loc, "CALL_FUNCTION_KW", 0x45, 0, 3)
#
...
#
def_op_graal(loc, "KWARGS_DICT_MERGE", 0x5A, 1, 0, 2)
#
