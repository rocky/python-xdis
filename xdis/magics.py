...
add_canonic_versions(
    ...
    "3.8.10 3.8.11 3.8.12 3.8.13 3.8.14",
    "3.8.0rc1+",
)
add_canonic_versions(
...
add_canonic_versions(
    ...
    "3.9.14 3.9.10pypy 3.9.11pypy 3.9.12pypy 3.9.0b5+",
    "3.9.0beta5",
)

add_canonic_versions("3.10 3.10.0 3.10.1 3.10.2 3.10.3 3.10.4 3.10.5 3.10.6 3.10.7", "3.10.0rc2")
