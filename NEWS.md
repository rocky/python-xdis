...
Added knowlege of Python versions 3.6.15 and 3.7.12.

However the main motivatation was to impove packaging to handle administration
...
Use the wheel for only the 3.6 and newer version of Python.
2Use eggs for other versions.
